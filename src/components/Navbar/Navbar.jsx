...
const Navbar = () => {
    const [sticky, setStkicky]=useState(false);

    useEffect(()=>{
        window.addEventListener('scroll',()=>{
            window.scrollY>50 ? setStkicky(true): setStkicky(false)
        })
    },[]);
    ...
    <div>
        <nav className={`container  ${sticky ? 'dark-nav' : ''}`}>
            ...
            <ul className={mobileMenu ? '' : 'hide-mobile-menu'}>
                ...
                <li>
                    <Link to ='testimoials' smooth={true} offset={-260} duration={500}>Testimonials</Link>
                </li>
